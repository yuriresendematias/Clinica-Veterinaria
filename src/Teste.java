...
public class Teste {
    public static void main(String[] args) {
        ...
        FachadaVeterinario vet = new FachadaVeterinario("000", "555");
        vet.cadastrarProcedimento(50, "vacinacao", 2);
        vet.cadastrarProcedimento(100, "atendimento", 1);
        vet.cadastrarProcedimento(30, "banho");
        vet.cadastrarProcedimento(40, "banho e tosa");
